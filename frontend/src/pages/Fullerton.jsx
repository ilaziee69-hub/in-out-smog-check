      ...
      <main className="placentia-page">
        <section className="pl-hero">
          ...
          <figure className="pl-shop-photo">
            <img src="/_next/image?url=%2Fphotos%2Fstorefront-approved-final.jpg&w=1200&q=70" width="1147" height="828" alt="In & Out Smog Check storefront near Fullerton in Placentia" />
        ...
        <section className="pl-service-split pl-local-split">
          <figure>
            <img src="/_next/image?url=%2Fphotos%2Finspection-bay.jpg&w=1080&q=70" width="864" height="648" alt="Vehicle inspection bay at In & Out Smog Check near Fullerton" />
        ...
        <section className="pl-water-tower">
          ...
          <figure>
            <img src={`/_next/image?url=${encodeURIComponent(CSUF_PHOTO)}&w=1080&q=70`} width="1000" height="750" alt="Cal State Fullerton Student Recreation Center in Fullerton, California" loading="lazy" />
