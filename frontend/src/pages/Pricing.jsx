  ...
  return <>
    ...
    <main className="placentia-page">
      ...
      <section className="prose pricing-body">
        <aside className="price-featured" aria-labelledby="pricing-featured-title"><p id="pricing-featured-title" className="pf-eyebrow">MOST COMMON PRICE · 2000 &amp; NEWER CARS</p><p className="pf-price" style={{color:"#000"}}>$60</p><ul className="pf-highlights"><li style={{color:"#d71920"}}><span aria-hidden="true">✓</span> CERTIFICATE FEE INCLUDED</li><li style={{color:"#d71920"}}><span aria-hidden="true">✓</span> ONE FREE RETEST WITHIN 30 DAYS</li></ul><p className="pf-time">Most standard inspections are completed in about 10 minutes.</p><p className="pf-sub">STAR Test-Only · Walk-ins welcome · No repair sales pitch</p><div className="pf-actions"><a href="tel:+17149931660" className="btn primary">Call Now</a><a href={directionsUrl} target="_blank" rel="noopener noreferrer" className="btn">Get Directions</a></div></aside>
