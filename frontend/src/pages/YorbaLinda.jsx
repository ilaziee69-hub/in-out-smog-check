      ...
      <main className="placentia-page">
        <section className="pl-hero">
          ...
          <figure className="pl-shop-photo">
            <img src="/photos/storefront-approved-final.jpg" alt="In & Out Smog Check storefront near Yorba Linda in Placentia" />
        ...
        <section className="pl-service-split pl-local-split">
          <figure>
            <img src="/photos/inspection-bay.jpg" alt="Vehicle inspection bay at In & Out Smog Check near Yorba Linda" />
