    ...
    <section className="location-verify" data-testid="location-verify-section" id="finding-us" aria-labelledby="finding-us-heading">
      <div className="lv-inner">
        ...
        <figure className="lv-illmap" data-testid="lv-illmap">
          <img src="/_next/image?url=%2Fphotos%2Fillustrated-map-v2.png&w=1200&q=70" width="1536" height="1024" alt="Illustrated map showing In & Out Smog Check at Bradford Ave and Center St in Placentia" loading="lazy" decoding="async" />
        ...
        <div className="lv-photos" data-testid="lv-photos">
          <figure className="lv-photo lv-photo-lead" data-testid="lv-photo-storefront">
            <div className="lv-photo-inner"><img src="/_next/image?url=%2Fphotos%2Fstorefront-approved-final.jpg&w=1200&q=70" width="1147" height="828" alt="In & Out Smog Check storefront at 144 S Bradford Ave in Placentia" loading="lazy" decoding="async" /><span className="lv-photo-tag">LOOK FOR OUR SHOP</span></div>
          ...
          <figure className="lv-photo" data-testid="lv-photo-bradford"><div className="lv-photo-inner"><img src="/_next/image?url=%2Fphotos%2Fbradford-center.jpg&w=1080&q=70" width="864" height="648" alt="Bradford Ave and Center St near In & Out Smog Check in Placentia" loading="lazy" decoding="async" /><span className="lv-photo-tag">BRADFORD &amp; CENTER</span></div><figcaption>Turn near this intersection</figcaption></figure>

          <figure className="lv-photo" data-testid="lv-photo-tonys"><div className="lv-photo-inner"><img src="/_next/image?url=%2Fphotos%2Ftonys-deli.jpg&w=1080&q=70" width="864" height="648" alt="Tony's Deli on Bradford Ave, a landmark north of In & Out Smog Check" loading="lazy" decoding="async" /><span className="lv-photo-tag">TONY&rsquo;S DELI</span></div><figcaption>Tony&rsquo;s Deli is a nearby landmark just north of us on Bradford Ave.</figcaption></figure>

          <figure className="lv-photo" data-testid="lv-photo-farolito"><div className="lv-photo-inner"><img src="/_next/image?url=%2Fphotos%2Fel-farolito.jpg&w=1080&q=70" width="864" height="648" alt="El Farolito across Center St from In & Out Smog Check in Placentia" loading="lazy" decoding="async" /><span className="lv-photo-tag">ACROSS FROM EL FAROLITO</span></div><figcaption>El Farolito is directly across the street</figcaption></figure>

          <figure className="lv-photo" data-testid="lv-photo-senior"><div className="lv-photo-inner"><img src="/_next/image?url=%2Fphotos%2Fsenior-center.jpg&w=1080&q=70" width="864" height="648" alt="Placentia Senior Center across from In & Out Smog Check near Bradford Ave" loading="lazy" decoding="async" /><span className="lv-photo-tag">SENIOR CENTER / OLD LIBRARY</span></div><figcaption>The Placentia Senior Center / Old Library is across from us near Bradford &amp; Center.</figcaption></figure>

          <figure className="lv-photo" data-testid="lv-photo-licensed"><div className="lv-photo-inner"><img src="/_next/image?url=%2Fphotos%2Flicensed-bay-sign.jpg&w=1080&q=70" width="864" height="648" alt="Bay entrance at In & Out Smog Check in Placentia" loading="lazy" decoding="async" /><span className="lv-photo-tag">STOP RIGHT IN FRONT OF THE BAY DOOR</span></div><figcaption>A technician will come greet you and begin the test.</figcaption></figure>
        </div>
      </div>
    </section>
  );
